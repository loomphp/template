...
namespace LooTest\Template;

use ArrayObject;
use League\Plates\Engine;
use PHPUnit\Framework\TestCase;
use Loom\Template\PlatesRenderer;
use Loom\Template\Exception;
...
class PlatesRendererTest extends TestCase
{
    ...
    public function testAddParameterThrowsExceptionOnEmptyTemplateName()
    {
        $this->expectException(Exception\InvalidArgumentException::class);
        $renderer = new PlatesRenderer();
        $renderer->addDefaultParam('', 'name', 'augusito');
    }

    public function testAddParameterThrowsExceptionOnEmptyParameter()
    {
        $this->expectException(Exception\InvalidArgumentException::class);
        $renderer = new PlatesRenderer();
        $renderer->addDefaultParam($renderer::TEMPLATE_ALL, '', 'augusito');
    }
}
